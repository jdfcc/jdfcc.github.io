...
tags:
  - Blog
slug: centos安装java和maven
permalink: /2026/03/24/centos安装java和maven/
description: >-
  下载java 下载maven 解压 路径是：/opt/maven/apache maven 3.9.5 配置 PATH
  配置修改完成后，有立即生效的需求时，使用命令：`source /etc/profile` 上面是针对使用ssh的配置。如
---
### 下载java
