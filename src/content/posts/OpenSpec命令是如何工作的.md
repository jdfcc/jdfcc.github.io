---
title: OpenSpec命令是如何工作的
created: '2026-08-11'
tags: []
slug: OpenSpec命令是如何工作的
permalink: /2026/08/11/OpenSpec命令是如何工作的/
description: >-
  命令是如何工作的 首先只需要记住一件事：OpenSpec 有两种命令，它们运行在两个不同的地方。 openspec ... 命令运行在你的 终端
  中。（例如：openspec init。） /opsx:... 命令运行在你的 AI 助手聊天
---
# 命令是如何工作的
