---
title: ElasticSearch下载安装及使用
created: '2026-03-24'
tags:
  - Blog
slug: ElasticSearch下载安装及使用
permalink: /2026/03/24/ElasticSearch下载安装及使用/
description: >-
  ElasticSearch下载安装及使用 前言
  Elasticsearch是一个基于Lucene的搜索服务器。它提供了一个分布式的全文搜索引擎，基于restful
  web接口。Elasticsearch是用Java语言开发的，基于Apach
---
