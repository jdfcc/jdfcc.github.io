---
title: 小米手机安装面具教程（Xiaomi手机获取root权限）
created: '2026-03-24'
tags:
  - Blog
slug: 小米手机安装面具教程（Xiaomi手机获取root权限）
permalink: /2026/03/24/小米手机安装面具教程（Xiaomi手机获取root权限）/
description: >-
  小米手机安装面具教程（Xiaomi手机获取root权限） 理论上安卓设备都能刷，只要能解锁BL就可以（如果不能解锁，推荐 ） 大致思路：设备解锁 –
  系统包提取boot – 面具修补boot – fastboot刷入修补文件 骁龙8Gen2
---
