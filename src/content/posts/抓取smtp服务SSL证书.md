...
tags: []
slug: 抓取smtp服务SSL证书
permalink: /2026/03/24/抓取smtp服务SSL证书/
description: "一键脚本 ，可以直接把 SMTP 服务器证书保存为 server.crt 文件： \U0001F4CC Linux Shell 脚本（保存为 get smtp cert.sh） \U0001F4CC 使用方法 1. 保存脚本： 粘贴进去。 2. 给执行权限： 3. 运行（"
---
